...
-- Carga de registros en tabla Categorias
...
-- Confirmar que la tabla se cargó correctamente
SELECT * FROM categorias;


-- Carga de registros en tabla Clientes
...
-- Carga de registros en tabla Productos
...
-- Carga de registros en tabla Ventas
